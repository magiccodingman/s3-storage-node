...
class HealthState:
    def __init__(self) -> None:
        ...
        self.index_repair: dict[str, Any] = {
            ...
            "current_volume_id": 0,
            "verified_volume_ids": [],
            "resolved_without_install_volume_ids": [],
            "failed_volume_ids": [],
            "last_error": "",
            "started_at": 0.0,
            "updated_at": 0.0,
...
class Handler(BaseHTTPRequestHandler):
    ...
    def _metrics(self, snapshot: dict[str, Any]) -> None:
        lines = [
            ...
            "# TYPE s3_storage_node_index_repairs_resolved_without_install_total counter",
            f"s3_storage_node_index_repairs_resolved_without_install_total {snapshot['index_repair'].get('counters', {}).get('resolved_without_install_total', 0)}",
